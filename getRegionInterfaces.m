function [bounds,cons,mesh,key] = getRegionInterfaces(mesh, regions,getComponents)
%GETREGIONINTERFACES Summary of this function goes here
%   Detailed explanation goes here

functionExtract =@min; 
if exist('getComponents','var') &&(getComponents==true)
    functionExtract =@max; 
end
...
if size(mesh.vertex,1)==length(mesh.vertex)
